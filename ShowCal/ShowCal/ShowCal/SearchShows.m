...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([temp.startYear length] == 5)
    {
        ...
        s2 = [NSKeyedUnarchiver unarchiveObjectWithData:encodedObject];
        s.showSaved = temp;
        homeScreen.saved = s;
        [s2 addObject:s];
        homeScreen.allSavedShows = s2;
        NSData *encodedObject2 = [NSKeyedArchiver archivedDataWithRootObject:homeScreen.allSavedShows];
        NSUserDefaults *defaults2= [NSUserDefaults standardUserDefaults];
        [defaults2 setObject:encodedObject2 forKey:@"save"];
